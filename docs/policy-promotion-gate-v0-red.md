# Advisory Policy Promotion Gate v0 — TDD RED v3 Evidence
...
**Corrected RED v3 branch:** `tdd/advisory-policy-promotion-gate-v0-red-v3-20260824`
...
This corrected RED v3 supersedes the original test tree for product qualification without rewriting the original immutable evidence.
