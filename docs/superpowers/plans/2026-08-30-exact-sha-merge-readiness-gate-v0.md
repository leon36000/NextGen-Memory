...
**Spec:** `docs/superpowers/specs/2026-08-30-exact-sha-merge-readiness-gate-v0-design.md`

## Global Constraints

- Exact base branch: `candidate/exact-sha-review-attestation-registry-v0-r3-20260829`.
- Exact base SHA: `f4d9388c14dd1f746f904b3724767f73f82786fd`.
...
**Interfaces:**
- Consumes: existing exact r3 public types `ExactShaReviewRequest`, `ReviewAttestationRegistrySummary`, `ReviewAttestationDecision`, `ReviewAdvisoryState`, and related review enums.
...
Copy each test independently into an isolated worktree at `f4d9388c14dd1f746f904b3724767f73f82786fd`. Each collection must fail only with:
...
git push origin HEAD:tdd/exact-sha-merge-readiness-gate-v0-red-20260830
```
...
Compare to base `f4d9388c14dd1f746f904b3724767f73f82786fd` and require exactly the nine design-spec paths. Reject any workflow, migration, dependency, database adapter, merge executor, feedback writer, activation path, release path, or corrective-retrieval source.

- [ ] **Step 4: Publish one immutable candidate**

```bash
git push origin HEAD:feat/exact-sha-merge-readiness-gate-v0-20260830
git push origin HEAD:candidate/exact-sha-merge-readiness-gate-v0-20260830
```
...
Base the product PR on `candidate/exact-sha-review-attestation-registry-v0-r3-20260829`. The packet binds exact base/candidate SHA, diff digest, acceptance criteria, tests, artifacts, residual risks, and allowed verdicts:
